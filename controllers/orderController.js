...
const placeOrder = async (req, res) => {
  const frontend_url = "https://foodprep-userfront-rb31.onrender.com"
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      mode:        'payment',
      success_url: `${frontend_url}/index.html/verify?success=true&orderId=${newOrder._id}`,
      cancel_url:  `${frontend_url}/index.html/verify?success=false&orderId=${newOrder._id}`
    })
